...
//---------------------------------------------------//
    remove_validations_errors(){
        const elements = ['error-pseudo','error-email','error-password','error-register','error-confPassword']
...
validations_pseudo(){
        if(document.getElementById('error-pseudo')){document.getElementById('error-pseudo').remove()}
        ...
        return {pseudo:Pseudo_elment.value}
}
//---------------------------------------------------//
validations_email(){
        ...
        return {email:Email_elment.value}
}
//---------------------------------------------------//
validations_password(){
        if(document.getElementById('error-password')){document.getElementById('error-password').remove()}
        const errorsElements = this.create_elements_errors()
        ...
        return {password:Pass_element.value}
}
//---------------------------------------------------//
validations_confPassword(){
        if(document.getElementById('error-confPassword')){document.getElementById('error-confPassword').remove()}
        const errorsElements = this.create_elements_errors()
        ...
        return {confPassword:Pass_element.value}
}
//---------------------------------------------------//
validations_comment(inputId){
        if(document.getElementById('error-comment')){document.getElementById('error-comment').remove()}
        const errorsElements = this.create_elements_errors()
        ...
        return {comment:comment_element.value}
}
//---------------------------------------------------//
validations_control(){
    ...
    if(!pseudo || !email || !password){
        ...
        return {pseudo:pseudo.pseudo,email:email.email,password:password.password}
    }
}
//---------------------------------------------------//
}
